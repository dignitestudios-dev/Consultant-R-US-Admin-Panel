...
<div
      ...
      {/* <h1 className="text-white p-8 pl-4">LOVERESTORED.AI</h1> */}
       {sidebarData?.map((sidebar) => (
        <NavLink
          ...
          className={({ isActive }) =>
            isActive
              ? "text-[14px]  font-bold flex items-center gap-4 px-6 py-3 rounded-full button-bg text-white hover:bg-[#DAB462] transition-all duration-200 ease-in-out"
    ...
    <hr className="border-t border-gray-600" />
      ...
      <button
        ...
        className="text-sm font-semibold  flex items-center gap-4  px-[14px] py-3 rounded-full text-white hover:bg-[#DAB462] hover:text-white transition-all duration-200 ease-in-out"
      >

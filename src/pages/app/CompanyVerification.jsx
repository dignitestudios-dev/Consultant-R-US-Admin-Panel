...
const CompanyVerification = () => {
  ...
  const company = {
    ...
    logo: "https://cdn-icons-png.flaticon.com/512/5968/5968705.png", // sample logo
  };
  ...
  return (
    <div className="p-6 min-h-screen pt-0 bg-[#0B0F19] text-white">
      {/* Header */}
      <div className="relative p-6 rounded-xl border border-gray-700 shadow-md bg-[#0C111D] mt-4">
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#DAB462] to-transparent rounded-t-3xl" />
        <h1 className="text-[32px] md:text-[36px] font-bold mb-2">

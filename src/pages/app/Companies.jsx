            ...
            : Array(5)
                ...
                .map((_, idx) => (
                  ...
                  >
                    ...
                    <div className="font-semibold">Acme Corp {idx + 1}</div>
                    <div className="text-sm opacity-80 truncate font-semibold">
                      contact{idx}@acme.com
                    </div>
                    <div className="text-sm">Sep {5 + idx}, 2025</div>
                    <div>
                    ...
                    <div>
                      ...
                      >
                        <FaEye className="w-4 h-4 mr-2 text-[#DAB462]" />
                        View Details
                      </button>
                    </div>
                  </div>
